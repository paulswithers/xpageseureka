...
public class DataInitializer {
	...
	/**
	 * @author withersp This function create a random user in memory
	 */
	public void createUserLottery() {
		try {
			...
			JSFUtil.getViewScope().put("firstName", firstName);
			JSFUtil.getViewScope().put("lastName", lastName);
			JSFUtil.getViewScope().put("city", fullcity);
			Thread.sleep(1000);
		} catch (Exception e) {
			e.printStackTrace();
		}
